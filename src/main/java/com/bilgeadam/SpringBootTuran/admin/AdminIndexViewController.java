...
public class AdminIndexViewController {
    ...
    public AdminIndexViewController(ETicaret_CategoriesServiceImpl eTicaret_CategoriesServiceImpl,ETicaret_ProductsServiceImpl eTicaret_ProductsServiceImpl) {
    ...
    @RequestMapping(value = "/Admin/adminallindex", method = RequestMethod.GET)
