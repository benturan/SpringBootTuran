...
<body  >
	...
	<script>
										function getManset( )
										{
									   alert('getMasset cagrildi');
										$.ajax('/getAllMansets/', {
										    type: 'GET',  // http method
										    data: { },
										    success: function (responsem, status, xhr) {
											    alert(responsem);
										    	   var lenm = responsem.length;
									                for(var im=0; im<lenm; im++){
									                   
									                    var categoryId = responsem[im].categoryId;
									                     
									                    var baslik = responsem[im].baslik;
									                    
									                    var imagem = responsem[im].image;
									                   
									                    var detay = responsem[im].detay;
									                      
									                 

									                     var abc = '<div class="ms-slide" data-delay="7">'+
									                    ...
									                    ' class="dark-color ms-layer" data-effect="top(50,true)"'+ 
															' data-duration="700" data-delay="250" data-ease="easeOutQuad">'+baslik+'" </h2>'+
															'<p style="width: 456px; left: 110px; top: 210px;"'+
															' class="dark-color ms-layer" data-effect="back(500)"'+ 
															' data-duration="700" data-delay="500" data-ease="easeOutQuad">'+detay+'</p>'+
															'<div style="left: 110px; top: 300px;" class="ms-layer button"'+
															' data-effect="left(50,true)" data-duration="500" data-delay="750" data-ease="easeOutQuad">'+
															'<a class="btn btn-black" href="#"> Kataloğa Git</a>'+
														    '</div>'+ 
														    '<div style="left: 350px; top: 300px;" class="ms-layer button"'+
														    ' data-effect="bottom(50,true)" data-duration="700" data-delay="950" data-ease="easeOutQuad">'+
														    '<a class="btn btn-primary" href="#"> Kategorilere Gözat</a>'+
									                    '</div>'+
									                    '</div>';
									 
									          	       
									          	   $("#hero-slider").html(abc);
