			...
			<div class="master-slider" id="hero-slider">
				...
				<div class="ms-slide" data-delay="7">
					...
					<img src="masterslider/blank.gif"
						data-src="img/hero/slideshow/slide_1.png" alt="" />
					<h2 style="width: 456px; left: 110px; top: 110px;"
						class="dark-color ms-layer" data-effect="top(50,true)"
						data-duration="700" data-delay="250" data-ease="easeOutQuad">Look
						for all bags at our shop!</h2>
					<p style="width: 456px; left: 110px; top: 210px;"
						class="dark-color ms-layer" data-effect="back(500)"
						data-duration="700" data-delay="500" data-ease="easeOutQuad">In
						this slider (which works both on touch screen and desktop devices)
						you can change the title, the description and button texts. It's
						all that you need to demonstrate your top rated products.</p>
					<div style="left: 110px; top: 300px;" class="ms-layer button"
						...
						<a class="btn btn-black" href="#">Kataloğa Git</a>
					</div>
					<div style="left: 350px; top: 300px;" class="ms-layer button"
						data-effect="bottom(50,true)" data-duration="700" data-delay="950"
						data-ease="easeOutQuad">
						<a class="btn btn-primary" href="#">Katagorilere Gözat</a>
					</div>
				</div>

				<!--Slide 2-->
				<div class="ms-slide" data-delay="7">
					<span class="overlay"></span> <img src="masterslider/blank.gif"
						data-src="img/hero/slideshow/slide_2.png" alt="Necessaire" />
					<h2 style="width: 456px; left: 110px; top: 110px;"
						class="dark-color ms-layer" data-effect="bottom(50,true)"
						data-duration="700" data-delay="250" data-ease="easeOutQuad">Necessaire</h2>
					<p style="width: 456px; left: 110px; top: 210px;"
						class="dark-color ms-layer" data-effect="bottom(50,true)"
						data-duration="700" data-delay="500" data-ease="easeOutQuad">In
						this slider (which works both on touch screen and desktop devices)
						you can change the title, the description and button texts. It's
						all that you need to demonstrate your top rated products.</p>
					<div style="left: 110px; top: 330px;" class="ms-layer button"
						data-effect="left(50,true)" data-duration="500" data-delay="750"
						data-ease="easeOutQuad">
						<a class="btn btn-black" href="#">Kataloğa Git</a>
					</div>
					<div style="left: 350px; top: 330px;" class="ms-layer button"
						data-effect="bottom(50,true)" data-duration="700" data-delay="950"
						data-ease="easeOutQuad">
						<a class="btn btn-primary" href="#">Katagorilere Gözat</a>
					</div>
				...
				<div class="ms-slide" data-delay="7">
					<div class="overlay"></div>
					<img src="masterslider/blank.gif"
						data-src="img/hero/slideshow/slide_2.png" alt="Crescent" />
					<h2 style="width: 456px; left: 110px; top: 110px;"
						class="dark-color ms-layer" data-effect="left(50,true)"
						data-duration="700" data-delay="250" data-ease="easeOutQuad">Crescent</h2>
					<p style="width: 456px; left: 110px; top: 210px;"
						class="dark-color ms-layer" data-effect="left(50,true)"
						data-duration="700" data-delay="500" data-ease="easeOutQuad">In
						this slider (which works both on touch screen and desktop devices)
...
<script>
    	$(document).ready(function() {
             ...
             //urunler baslangic
               ...
               // ana kategori baslangic  
               $.when($.get(url2, function (response2) {
 
                })).then(function (response2) {
                   // alert('main categori cagrildi');
                   // alert(response);
                    var len = response2.length;
                    for(var i2=0; i2<len; i2++){
                        var categoryname= response2[i2].categoryname;
                        var imgsrc = response2[i2].imgsrc;
                        

                        var tr_str2 = '<div class="category col-lg-2 col-md-2 col-sm-4 col-xs-6">'+ 
                        '<a href="#"><img src="'  + imgsrc +'" /><p>'+categoryname+'</p> </a>'+ 
                        '</div>';
  
              	  $("#mainCategories").append(tr_str2);
               ...
               //topcategoriler baslıyor
            // ana kategori baslangic  
      		 var urlTopCategories = '/getMainCategories/';
      		 var urlTopSubCategories = '/getMainSubCategories/';
      		 var  responseTopCategoriesArray;
      		 alert('kategoriler asladi mi');
      		  $.when($.get(urlTopCategories, function (responseTopCategories) {

      			  alert('wehen');
                })).then(function (responseTopCategories) { 
                	window.responseTopCategoriesArray = responseTopCategories 
              	  alert(window.responseTopCategoriesArray);
                   
                     
                });
             //sub categoriler baslıyor
         $.get(urlTopSubCategories, function (responseTopSubCategories) {
	 alert('sub cateoriler when');
            
            	 alert('sub cateoriler then'); 

            	 var lenSub = responseTopSubCategories.length;
                 var Sub2 = responseTopSubCategories;
                 var tr_strTopCategories;
                 alert(window.responseTopCategoriesArray);
                 alert(window.responseTopCategoriesArray.length);
                 for(var iMain=0; iMain<lenSub; iMain++){

                   
                   //  var anakategoricategoryid = responseTopCategoriesArray[iMain].categoryid;
                     //alert(anakategoricategoryid);
