...
<body class="ecom-products-page">
	...
	<jsp:include page="header.jsp"></jsp:include>
		...
		<section id="content_wrapper">
			...
			<ul class="nav nav-list nav-list-topbar pull-left">
						...
						<li class="active"><a href="/Admin/adminallproducts">Urunler</a></li>
						<li><a href="/Admin/adminallorders">Siparisler</a></li>
						<li><a href="/Admin/adminallusers">Uyeler</a></li>
						<li ><a href="/Admin/adminallcategories">Kategoriler</a>
						</li>
					</ul>
				</div>
			...
			<section id="content" class="table-layout animated fadeIn">
				...
				<div class="tray tray-center">
					...
					<form name = "formum" id="formum" method="post" class="add-product" action="/addProduct"
						enctype="multipart/form-data">
						<div class="panel mb25 mt5">
							<div class="panel-heading">
								<span class="panel-title hidden-xs">Yeni Ürün Ekle</span>
								<ul class="nav panel-tabs-border panel-tabs">
									<li class="active"><a href="#tab1_1" data-toggle="tab">Genel</a>
									</li>
									<li><a href="#tab1_2" data-toggle="tab">Detay</a></li>
								</ul>
							</div>
								...
								<div class="tab-content pn br-n admin-form">
										...
										<div class="section row mbn">
											<div class="col-md-4">
												...
												<div class="fileupload fileupload-new admin-form"
													...
													<div id="anaresim" name="anaresim" class="fileupload-preview thumbnail mb20">
														<img id="resim" name="resim" data-src="holder.js/100%x140" alt="holder">
													</div>
											...
											<div class="col-md-8 pl15">
												<div class="form-group group">
													<div class="section mb10">
														<label for="name2" class="field prepend-icon"> <input
															type="text" name="name2" id="name2"
															class="event-name gui-input br-light light"
															placeholder="Ürün Adı"> <label for="name2"
												...
												<div class="form-group group">
													<div class="section mb10">
														<label class="field prepend-icon"> <textarea
																style="height: 160px;"
																class="gui-textarea br-light bg-light" id="comment"
																name="comment" placeholder="Ürün Detayı"></textarea> <label
															for="comment" class="field-icon"> <i
																class="fa fa-comments"></i>
														</label> <span class="input-footer hidden"> <strong>Hint:</strong>Don't
												...
												<div class="form-group group">
												<div class="section mb10" name="cboxicin" id="cboxicin" style="display: none;">
									...
									<div id="tab1_2" class="tab-pane">
										...
										<div class="section row">
											<div class="form-group group">
												<div class="col-md-12">
													<label class="field select"> <select id="sales"
														name="sales">
											...
											<div class="form-group group">
												<div class="col-md-12">
													<label for="product-price" class="field prepend-icon">
														...
														class="gui-input" placeholder="Ürün Fiyatı"> <label
										...
										<div class="section row mbn">
											<div class="col-sm-12">
												<p class="text-right">
													<button class="btn btn-primary" type="submit" id="ürünekle"
														name="ürünekle">Ürün Ekle</button>
												</p>
											</div>
										</div>
					</form>
				...
				<div id="tab1_3" class="tab-pane">
					...
					<div class="section row">
						<div class="col-md-3">
							<label for="zip" class="field prepend-icon"> <input
								...
								placeholder="Zip"> <label for="zip" class="field-icon">
						...
						<div class="col-md-4">
							<label for="city" class="field prepend-icon"> <input
								...
								placeholder="City"> <label for="city" class="field-icon">
					...
					<div class="section row mbn">
						<div class="col-sm-8">
							<label class="field option mt10"> <input type="checkbox"
								name="info" checked> <span class="checkbox"></span>Save
								Customer <em class="small-text text-muted">- A Random
									Unique ID will be generated</em>
							</label>
						</div>
						<div class="col-sm-4">
							<p class="text-right">
				...
				<table class="table admin-form theme-warning tc-checkbox-1 fs13">
					...
					<tbody>
						...
						<c:forEach items="${adminproductlists}" var="product">
							<tr>
								<td class="w100"><img class="img-responsive mw40 ib mr10"
									title="user" src="${product.image}"></td>
								...
								<td class="text-right">
									<div class="btn-group text-right">
										<c:choose>
											<c:when test="${product.sales == 1}">
												<button type="button"
													...
													Stokta Var <span class="caret ml5"></span>
												</button>
											</c:when>
											...
											<c:when test="${product.sales == 3}">
												<button type="button"
													...
													data-toggle="dropdown" aria-expanded="false">
													Stokta Yok <span class="caret ml5"></span>
												</button>
											</c:when>
										</c:choose>
										...
										<ul class="dropdown-menu" role="menu">
											<li><a href="#" onclick="Düzenle(${product.productID});">Düzenle</a></li>
											<li><a href="/deleteProduct/${product.productID}">Sil</a></li>											
										</ul>
									</div>
								</td>
							</tr>
		...
		<div class="admin-form">
			...
			<div class="section mb15">
				<label for="order-id" class="field prepend-icon"> <input
					...
					placeholder="Product SKU #"> <label for="order-id"
					class="field-icon"> <i class="fa fa-tag"></i>
				</label>
				</label>
			</div>
			...
			<div class="section row mb15">
				...
				<div class="col-md-6">
					<label for="price2" class="field prepend-icon"> <input
						...
						placeholder="1000"> <label for="price2" class="field-icon">
							<i class="fa fa-usd"></i>
					</label>
					</label>
				</div>
			...
			<div class="section mb15">
				<label class="field select"> <select id="filter-categories"
			...
			<div class="section">
				<label class="field select"> <select id="filter-customers"
  ...
  if (window.XMLHttpRequest) {
   ...
   function Düzenle(pid){
	   ...
	   var mydiv =document.getElementById("cboxicin");
	   ...
	   label.htmlFor = "id"; 
	   label.appendChild(document.createTextNode('Yeni Fotoğraf Yüklediyseniz Seçiniz.')); 

	   mydiv.appendChild(x); 
	   mydiv.appendChild(label); 

	   //checkbox işlemlerimin bitti yer

	   $('#categoryid')
       .empty()
       .append('<option value="0" selected="selected">Alt Kategori2</option>')
       ;
	   
	   try {
		   var ana = document.getElementById("anaresim");
		
		   while (ana.lastElementChild) {
			    ana.removeChild(ana.lastElementChild);
		   }

		   document.getElementById("ürünekle").innerHTML = "Güncelle";
		   document.getElementById("formum").action = "/updateProduct";
	   ...
	   if (requestObj) {
	          requestObj.open("GET", "/getProduct/" + pid);
	          requestObj.onreadystatechange = function ()
	          {
	              if (requestObj.readyState == 4 && requestObj.status == 200) {
	                     var options = JSON.parse(requestObj.responseText);
	                   for( var i=0; i<options.length; i++) { 
	                	   document.getElementById("name2").value = options[i][1];
	                	   document.getElementById("price").value = options[i][2];
	                	   document.getElementById("comment").value = options[i][3];
	                	   document.getElementById("sales").value = options[i][6]; 
	                	   img.src = "/resources/img/catalog/"+options[i][4]; 
	                	   document.getElementById('anaresim').appendChild(img);

	                	   var newOption = document.createElement('option');
		                   newOption.value = options[i][5];
		                   newOption.innerText = options[i][7];
		                   newOption.selected = "selected";
		                
		                

                           	                   
	                        document.getElementById('categoryid').appendChild(newOption);                	   
   ...
   function getCategories()
   {
       ...
       $('#product-status')
                 .empty()
                 .append('<option value="0" selected="selected">Alt Kategori</option>');
	              ...
	              if (requestObj.readyState == 4 && requestObj.status == 200) {
	                   ...
	                   for( var i=0; i<options.length; i++) { 
		                   ...
		                   newOption.innerText = options[i]["categoryname"];
	                        ...
	                        document.getElementById('product-status').appendChild(newOption);
	                   }
	              }
	          }
	          requestObj.send(null);
   ...
   function getCategories2()
   {
       ...
       $('#categoryid')
                 ...
                 .append('<option value="0" selected="selected">Alt Kategori2</option>')
                 ;
       var select = document.getElementById('product-status');
	    var currentCategory = select.options[select.selectedIndex];	    
	      if (requestObj) {
	          requestObj.open("GET", "/getCategory/" + currentCategory.text);
	          requestObj.onreadystatechange = function ()
